...
data_config = {
    'navsim': {
        ...
        'VIDEO_ROOT': '/mnt/datasets/zhangzhang/navsim/download/test_sensor_blobs/test',
        'VIDEO_CODES_SAVE': '/mnt/datasets/zhangzhang/navsim/download/processed_data/test_vq_codes',
        'VIDEO_RECON_SAVE': '/mnt/datasets/zhangzhang/navsim/download/processed_data/recon'
    }
}
...
if __name__ == "__main__":
    ...
    MODEL_HUB = "/mnt/datasets/zyr/VLA_Emu/pretrained_models/Emu3-VisionTokenizer"
    path = "/mnt/datasets/zyr/VLA_Emu/pretrained_models/Emu3-VisionTokenizer"
