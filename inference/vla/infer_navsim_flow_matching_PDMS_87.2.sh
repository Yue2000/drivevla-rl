...
# 模型和配置路径
export VLA_ACTION_TOKENIZER="${VLA_ACTION_TOKENIZER:-/mnt/datasets/zyr/VLA_Emu/pretrained_models/fast}"
export VLA_VLM_MODEL="${VLA_VLM_MODEL:-/mnt/datasets/yc/VLA_Emu/Emu3_Flow_Matching_Action_Expert_PDMS_87.2}"
export VLA_NORM_STATS="${VLA_NORM_STATS:-/home/user/yc/DriveVLA-W0/configs/normalizer_navsim_test/norm_stats.json}"
export VLA_TOKEN_YAML="${VLA_TOKEN_YAML:-/home/user/yc/DriveVLA-W0/inference/navsim/navsim/navsim/planning/script/config/common/train_test_split/scene_filter/navtest.yaml}"

# 推理参数（可通过环境变量覆盖）
export EMU_HUB="${EMU_HUB:-/mnt/datasets/yc/VLA_Emu/Emu3_Flow_Matching_Action_Expert_PDMS_87.2}"
export OUTPUT_DIR="${OUTPUT_DIR:-/mnt/datasets/yc/ckpts/DriveVLA/test_navsim_flow_matching_20260420}"
export TEST_DATA_PKL="${TEST_DATA_PKL:-/mnt/datasets/zhangzhang/navsim/download/processed_data/meta/navsim_emu_vla_256_144_test_pre_1s_real_path.pkl}"

# 可选参数
# export VLA_NUM_WORKERS="${VLA_NUM_WORKERS:-12}"
export VLA_NUM_WORKERS="${VLA_NUM_WORKERS:-0}"
export VLA_BATCH_SIZE="${VLA_BATCH_SIZE:-1}"
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

# Anchor 相关路径（用于模型内部，可通过环境变量覆盖）
export VLA_ANCHOR_CLUSTER_PATH="${VLA_ANCHOR_CLUSTER_PATH:-/mnt/datasets/zhangzhang/navsim/download/processed_data/cluster_centers_8192.npy}"
export VLA_ANCHOR_METRIC_SCORE_PATH="${VLA_ANCHOR_METRIC_SCORE_PATH:-/mnt/datasets/zhangzhang/navsim/download/processed_data/formatted_pdm_score_8192.npy}"
...
# 设置 PYTHONPATH
export PYTHONPATH="${DRIVEVLA_ROOT}/inference/navsim/navsim:${DRIVEVLA_ROOT}:${PYTHONPATH}"
export CUDA_VISIBLE_DEVICES=0,1,5,7,8,9
