...
class UniversalActionProcessor(ProcessorMixin):
    ...
    def decode(
        ...
        *,
        ...
        decoded_actions = []
        expected_elems = int(self.time_horizon * self.action_dim)
        ...
        for token in tokens:
            try:
                ...
                # - If too short, pad zeros (no energy)
                ...
                decoded_dct_coeff = coeff_flat.reshape(self.time_horizon, self.action_dim)
            ...
            # print(token, n, expected_elems)
            # print(decoded_actions[-1])
